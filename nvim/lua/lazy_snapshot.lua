return {
  ...
  { "numToStr/Comment.nvim", version = "^0.8" },                                          --Commenting
  { "JoosepAlviste/nvim-ts-context-commentstring", commit = "0bf8fbc2ca8f8cdb6efbd0a9e32740d7a991e4c3" },
  { "NMAC427/guess-indent.nvim", commit = "b8ae749fce17aa4c267eec80a6984130b94f80b2" },   --Formatting
  ...
  { "lervag/vimtex", commit = "5f0a79f2fa9f02eeac9b9902be83bc1b43a402fe" },
  ...
  --Highlighting and hints stuff
  { "lewis6991/gitsigns.nvim", version = "^0.6" },                                        --Git changes
  { "kevinhwang91/nvim-ufo", version = "^1" },                                            --Folding
  { "NvChad/nvim-colorizer.lua", commit = "dde3084106a70b9a79d48f426f6d6fec6fd203f7" },   --Colorcodes
  { "folke/which-key.nvim", version = "^1" },                                             --Keybind hints
  { "lukas-reineke/indent-blankline.nvim", version = "^2" },                              --Displaying of spaces
