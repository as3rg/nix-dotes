...
function set_wallpaper()
    awful.spawn.with_shell("find ~/Pictures/wallpapers -type f -name '*.jpg' -o -name '*.png' | shuf -n 1 | xargs -I {} feh --bg-fill {}")
end
...
-- awful.spawn.with_shell('setxkbmap -option "grp:win_space_toggle" "us,ru"')
